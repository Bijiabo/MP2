...
{
    AFHTTPRequestOperation *operation = [self creatGetOperationWithSaveKey:nil data:nil filePath:nil url:url];
...
- (AFHTTPRequestOperation *)creatGetOperationWithSaveKey:(NSString *)saveKey
                                                    data:(NSData *)data
                                                filePath:(NSString *)filePath url:(NSString*)requestUrl

{
    ...
    void(^success)(AFHTTPRequestOperation *operation, id responseObject)= ^(AFHTTPRequestOperation *operation, id responseObject){
        ...
        NSArray * jsonDic = [NSJSONSerialization JSONObjectWithData:operation.responseData options:NSJSONReadingAllowFragments error:NULL];
        
        //NSLog(  operation.responseString);
        NSString *xx = operation.responseString;
        
        NSUserDefaults *userdefault = [NSUserDefaults standardUserDefaults];
        
        [userdefault setObject:xx forKey:@"returnContent"];
        [userdefault setObject:jsonDic forKey:@"returnJsonData"];
        NSNotificationCenter *notificationCenter = [NSNotificationCenter defaultCenter];
        
        if (jsonDic != nil)
        {
            [notificationCenter postNotificationName:@"DownloadSuccessWithJsonData" object:nil];
            
        }else{
            [notificationCenter postNotificationName:@"DownloadSuccess" object:nil];
        }
    ...
    AFHTTPRequestOperation *operation =    [httpManager GET:requestUrl parameters:nil success:success
                                                    failure:fail];
